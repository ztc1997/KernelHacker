    ...
    private class ResourcesEdgeEffect extends Resources {
        ...
        public Drawable getDrawable(int resId) throws Resources.NotFoundException {
            ...
            if (resId == this.overscroll_edge) {
                mEdgeDrawable = ContextWrapperEdgeEffect.this.getBaseContext().getResources().getDrawable(R.mipmap.overscroll_edge);
                ret = mEdgeDrawable;
            } else if (resId == this.overscroll_glow) {
                mGlowDrawable = ContextWrapperEdgeEffect.this.getBaseContext().getResources().getDrawable(R.mipmap.overscroll_glow);
                ret = mGlowDrawable;
